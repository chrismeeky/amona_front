                ...
                <TabPanel>
                  <div className="ad-details__main__details__ad">
                    ...
                    <div className="ad-details__main__details__ad__description">
                      <p>
                        Just 3Months Crystal Mint Clean Direct 2010 Toyota
                        Corolla /URGENT SALES,CASH is needed today(Tokunbo
                        Standard/Going For an AFFORDABLE PRICE). The Corolla
                        line-up starts with the LE, which comes with the
                        2.4-litre with five-speed automatic, CD/MP3 player,DVD
                        Player, air conditioning, 60/40 folding rear seatbacks,
                        power locks with keyless entry, power windows, cruise
                        control, 16-inch steel wheels,intermittent wipers and
                        heated power mirrors,comfortable Silk fabric
                        Interior.This Ride Is just TOKUNBO with nothing to
                        fix,absolutely pay and drive.Interested and Serious
                        Buyers Should call or WhatsApp for more Details and
                        NEGOTIATIONS. Location:Ojodu-Berger,Lagos State‎.
                      </p>
                    </div>
